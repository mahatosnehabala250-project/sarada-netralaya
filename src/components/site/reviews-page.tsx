      ...
      <div className="bg-white border-b border-slate-200">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 text-center">
          ...
          <a
            ...
            className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-[#0047AB] px-7 py-3.5 text-base font-bold text-white hover:bg-[#0c4a5a] transition-colors"
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {GOOGLE_REVIEWS.map((url, i) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group rounded-2xl bg-white border border-slate-200 p-6 shadow-sm hover:shadow-lg hover:border-[#0047AB]/30 transition-all"
            >
              ...
              <div className="mt-3 font-bold text-[#0047AB]">Verified Google Review #{i + 1}</div>
              <span className="mt-1 inline-flex items-center gap-1 text-sm font-medium text-slate-500 group-hover:text-[#0047AB]">
