      ...
      <div className="bg-white border-b border-slate-200">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 text-center">
          <div className="inline-flex items-center gap-3 rounded-2xl bg-amber-50 border border-amber-200 px-6 py-4 mb-6">
            <div className="text-5xl font-bold text-[#0a3d4a]">{avg}</div>
          ...
          <a href={REVIEWS_URL} target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-[#0a3d4a] px-7 py-3.5 text-base font-bold text-white hover:bg-[#0c4a5a] transition-colors">
