    ...
    <section className="py-14 sm:py-20 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-8 sm:mb-10 flex-wrap gap-4">
          ...
          <Link
            href="/gallery"
            className="inline-flex items-center gap-1.5 text-sm font-bold text-[#0A5CFF] hover:text-[#094FCC] transition-colors group"
          >
            View full gallery
          ...
          {PREVIEW.map((p) => (
            ...
            >
              <div className="relative aspect-[4/3]">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A5CFF]/70 to-transparent" />
