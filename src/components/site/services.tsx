      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {SERVICES.map((s) => (
            <article
              key={s.title}
              className="group rounded-2xl bg-white border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl hover:shadow-[#0047AB]/8 hover:-translate-y-1 transition-all duration-300 flex flex-col"
            >
              {/* Image */}
