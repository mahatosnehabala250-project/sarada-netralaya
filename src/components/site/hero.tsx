...
export function Hero() {
  return (
    <section id="top" className="relative bg-gradient-to-br from-[#E6F0FF] via-[#F0F6FF] to-white overflow-hidden">
      {/* Top bar */}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight text-[#0047AB]">
              Your Vision,
              <br />
              Our Mission
            </h1>
            ...
            {/* Body copy */}
            <p className="text-base sm:text-lg text-[#333333] leading-relaxed max-w-lg">
            ...
            <div className="mt-8 flex items-center gap-6 pt-6 border-t border-[#E0E0E0]">
              ...
              <div>
                <div className="text-2xl font-bold text-[#0047AB]">4.9★</div>
                <div className="text-xs text-[#666] font-medium">Google Rating</div>
              </div>
              <div className="h-8 w-px bg-[#E0E0E0]" />
              <div>
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-[#0047AB]/20 aspect-[4/3]">
              <Image
