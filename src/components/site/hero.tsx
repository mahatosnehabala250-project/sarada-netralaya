...
export function Hero() {
  return (
    <section id="top" className="relative min-h-screen flex items-end overflow-hidden bg-[#0a3d4a]">
      ...
      {/* Content */}
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 pb-24 sm:pb-28 pt-28 sm:pt-32 w-full">
        <div className="max-w-3xl">
          {/* Eyebrow */}
          <div className="flex items-center gap-3 mb-5 sm:mb-6 reveal" style={{ animationDelay: "0.1s" }}>
            <span className="h-px w-10 sm:w-12 bg-emerald-400" />
            <span className="text-emerald-300 text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] sm:tracking-[0.25em]">
              Eye Care · Since 1995
            </span>
          </div>

          {/* Headline */}
          <h1 className="font-serif-display text-[2rem] xs:text-4xl sm:text-6xl lg:text-7xl font-bold leading-[1.1] sm:leading-[1.05] tracking-tight text-white reveal" style={{ animationDelay: "0.2s" }}>
            Caring for
            <br />
          ...
          {/* Subtext */}
          <p className="mt-6 sm:mt-8 max-w-xl text-sm sm:text-lg leading-relaxed text-white/70 reveal" style={{ animationDelay: "0.3s" }}>
          ...
          {/* CTAs */}
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 reveal" style={{ animationDelay: "0.4s" }}>
            <a
              href="#book"
              onClick={(e) => { e.preventDefault(); document.querySelector("#book")?.scrollIntoView({ behavior: "smooth" }); }}
              className="group inline-flex items-center justify-center gap-2 rounded-full bg-emerald-500 hover:bg-emerald-400 px-6 sm:px-7 py-3.5 sm:py-4 text-sm font-bold text-[#0a3d4a] transition-all hover:gap-3 min-h-[52px]"
            >
              Book Appointment
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 text-white px-6 sm:px-7 py-3.5 sm:py-4 text-sm font-bold hover:bg-white/10 transition-colors min-h-[52px]"
            >
          ...
          {/* Trust strip */}
          <div className="mt-10 sm:mt-14 flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-3 sm:gap-x-6 lg:gap-x-8 reveal" style={{ animationDelay: "0.5s" }}>
